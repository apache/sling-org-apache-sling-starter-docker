...
RUN wget https://repo1.maven.org/maven2/org/apache/sling/org.apache.sling.launchpad/9/org.apache.sling.launchpad-9.jar -O /opt/sling/org.apache.sling.launchpad.jar
WORKDIR /opt/sling/
EXPOSE 8080
